...
description: '既存コードを調査し、結果を Markdown 形式の構造化レポートとして報告するスキル。データドリブンな分析手法と実践的なテクニックを提供する。 使用タイミング: - 既存機能の調査時 - バグの原因特定時 - パフォーマンス問題の分析時 - アーキテクチャの理解・ドキュメント化時 - リファクタリング前の影響調査時 - 新規機能開発のための既存機能理解時'
---
# 調査レポート作成ガイド

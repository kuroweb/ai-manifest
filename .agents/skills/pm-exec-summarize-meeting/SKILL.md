...
description: >-
  会議 transcript を、日時、参加者、議題、決定事項、要点、action item を含む構造化メモに要約する。録画の処理、meeting
  notes 作成、議事録化、議論の振り返りに使う。
---
# 会議要約
...
7. **成果物を保存する**: `~/.docs/pm-exec/Meeting-Summary-[date]-[topic].md` の名前で Markdown 保存する。

...
name: learn-short
description: >
  `~/.docs/learn/daily-term/` の未レビュー原本を重複テーマごとに整理し、`~/.docs/learn/short-term/` に
  short-term ファイルを作る。

  `learn-short` を明示したとき、または「short-term に整理して」「daily-term をまとめて」「重複テーマを整理して」のように
  short-term への整理を求められたときは使う。
---
# Learn Short

...
name: learn-daily
description: |
  `~/.docs/learn/daily-term/` に、セッションの失敗・手戻りを daily-term 原本として記録する。
  `learn-daily` を明示したとき、または「daily-term に記録して」「このセッションを daily にして」「知見を daily-term に残して」のように daily-term への記録を求められたときは使う。
---
# Learn Daily
